...
1. **Clone the repo**
   ```bash
   git clone https://github.com/vidyansh07/portfolio.git
   cd portfolio
   ```
...
- 💼 LinkedIn: [linkedin.com/in/vidyansh-shukla](https://linkedin.com/in/vidyansh-shukla)
- 🐙 GitHub: [@vidyansh07](https://github.com/vidyansh07)
